...
class MainView(wx.Panel):
    def __init__(self, parent):
        ...
        add_voter_to_campaign_campaign_name_choiceChoices = []
        ...
        add_nominee_to_campaign_campaign_name_choiceChoices = []
        ...
        get_results_campaign_name_choiceChoices = []
        self.get_results_campaign_name_choice = wx.Choice(get_results_sizer.GetStaticBox(), wx.ID_ANY,
                                                          wx.DefaultPosition, wx.Size(180, -1),
                                                          get_results_campaign_name_choiceChoices, 0)
